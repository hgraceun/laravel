    ...
    <div class="container">
                            ...
                            <tbody>
                                <tr v-for="(user, index) in users" :key="user.id">
                                    ...
                                    <td>
                                        ...
                                        <button @click="deleteUser(index)" class="btn btn-sm btn-danger">Delete
                                            User</button>
                                        <button @click="showContacts(user.id)" class="btn btn-sm btn-primary">View
        ...
        <div id="viewusercontactmodal" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add user contact</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button @click="submitContactNumber()" type="button" class="btn btn-primary">Add Contact</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
